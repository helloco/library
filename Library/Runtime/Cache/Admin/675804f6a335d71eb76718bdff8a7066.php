	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="active"><a href="<?php echo U('Admin/Admin/qrcodeView');?>"><i class="icon icon-home"></i> <span>其它</span></a></li>
		...
		<script type="text/javascript">
		function createQr(){
			ThinkAjax.send('<?php echo U("Admin/Admin/qrcode");?>','data='+$('form-field-0').value,complete,'result');
		}
